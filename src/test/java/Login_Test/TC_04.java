...
public class TC_04 extends Base {
  @Test(description="Enter Customer_ID with character")
  public void login_invalid_2() throws IOException 
	{
		...
		cust_id.sendKeys("kawsar");
		s.selectByVisibleText("Current");
		deposit.sendKeys("500");
		//submit.click();

		String ExpectedsuccesMessage="Characters are not allowed";
