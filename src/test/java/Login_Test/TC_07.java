...
public class TC_07 extends Base {
  @Test(description="Enter inital deposit  first character is blank")
  public void login_invalid_5() throws IOException 
	{
		...
		String ExpectedsuccesMessage="First character can not have space";
